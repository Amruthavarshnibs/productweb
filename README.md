    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                <div class="footer">
                <footer style="color:white">
                Copyright &copy;2023 Developed by Lokesh khanna</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ceoph{
            background-image: url(/static/images/pic1.png);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>amrutha</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>aashika</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>lokesh</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>janani</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>lokesh khanna</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>alaghu nachiyar</h2></b></p></div><br>
    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                <div class="footer">
                <footer style="color:white">
                Copyright &copy;2023 Developed by thuhin khanna</footer></div>
            </div>
        </div>
    </body>
</html>
...
## Output:
![image](https://user-images.githubusercontent.com/119103704/215162675-cdaee81f-6306-4de4-8212-32c983bd987e.png)
